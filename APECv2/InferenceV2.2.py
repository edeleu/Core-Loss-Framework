...
NUM_EPOCH = 470 #200
BATCH_SIZE = 256
LR_INI = 0.0011193544554220912 #0.0026
MIN_LR = LR_INI / 3.85
...
materials = {
    "N27" : ["/scratch/gpfs/ed5754/N27_TL/N27_R20.0X10.0X7.0_Data1_Seq2Scalar_Downsampled_Full.json", 0, 500,700,2000]}
...
def main():
    ...
    for epoch_i in range(NUM_EPOCH):
        ...
        # Afterwards, save model at every epoch and record validation error as an array. 
            ...
            torch.save(net.state_dict(), "/scratch/gpfs/ed5754/SzElevenOut/GeneralFramework" + str(epoch_i) + ".sd")
    ...
    with open("SzElevenOuts.csv", "w") as f:
        writer = csv.writer(f)
