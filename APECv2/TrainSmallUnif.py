...
NUM_EPOCH = 418 #200
BATCH_SIZE = 512
LR_INI = 0.0015009845002285787 #0.0026
MIN_LR = 0.0006780343562006442
...
class MagUniformer(nn.Module):
    def __init__(self, 
        ...
        self.projector =  nn.Sequential(
            nn.Linear(dim_val + projected_variables, 20),
            nn.GELU(),
...
def main():
    ...
    for epoch_i in range(NUM_EPOCH):
        ...
        # Afterwards, save model at every epoch and record validation error as an array. 
            ...
            torch.save(net.state_dict(), "/scratch/gpfs/ed5754/SzThreeGood/GeneralFramework" + str(epoch_i) + ".sd")
    ...
    with open("SzThreeGood.csv", "w") as f:
        writer = csv.writer(f)
