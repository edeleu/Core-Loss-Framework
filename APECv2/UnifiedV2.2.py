...
def main():
    ...
    optimizer = optim.AdamW(net.parameters(), lr=LR_INI) 
    ...
    for epoch_i in range(NUM_EPOCH):
        ...
        for in_B, freqTensor, parameterTensor, labels, out in trainData:
            ...
            torch.nn.utils.clip_grad_norm_(net.parameters(), max_norm=1.15)
            optimizer.step()
        ...
        # Afterwards, save model at every epoch and record validation error as an array. 
            ...
            torch.save(net.state_dict(), "/scratch/gpfs/ed5754/Clipped/GeneralFramework" + str(epoch_i) + ".sd")
    ...
    with open("ClippedOut.csv", "w") as f:
        writer = csv.writer(f)
