#here, we try /1k instead of log for core loss.
...
def main():
    ...
    for epoch_i in range(NUM_EPOCH):
        ...
        # Afterwards, save model at every epoch and record validation error as an array. 
            ...
            torch.save(net.state_dict(), "/scratch/gpfs/ed5754/Loga/GeneralFramework" + str(epoch_i) + ".sd")
