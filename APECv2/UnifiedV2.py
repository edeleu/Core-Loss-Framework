...
#Training Materials 
#materials: material name : [filepath,ID]
materials = {
    ...
    "3F4" : ["/scratch/gpfs/ed5754/3F4/3F4_E-32-6-20-R_Data1_Seq2Scalar_Downsampled_FullFixed.json", 3],
    "N30" : ["/scratch/gpfs/ed5754/N30/N30_22.1X13.7X6.35_Data1_Seq2Scalar_Downsampled_FullFixed.json", 4],
    "N49" : ["/scratch/gpfs/ed5754/N49/N49_R16.0X9.6X6.3_Data1_Seq2Scalar_Downsampled_FullFixed.json", 5],
}
...
def main():
    ...
    for epoch_i in range(NUM_EPOCH):
        ...
        # Afterwards, save model at every epoch and record validation error as an array. 
            ...
            torch.save(net.state_dict(), "/scratch/gpfs/ed5754/CombinedModel/GeneralFrameworkSix" + str(epoch_i) + ".sd")
