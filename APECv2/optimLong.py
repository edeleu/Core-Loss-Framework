...
random.seed(92323)
np.random.seed(92323)
torch.manual_seed(92323)
...
#Training Materials 
#materials: material name : [filepath,ID, Bsat, freqPeak]
materials = {
    "N87" : ["/scratch/gpfs/ed5754/N87/N87_R34.0X20.5X12.5_Data5_Seq2Scalar_Downsampled_FullFixed.json", 0, 490, 900],
    "3C90" : ["/scratch/gpfs/ed5754/3C90/3C90_TX-25-15-10_Data1_Seq2Scalar_Downsampled_FullFixed.json", 1, 470, 600],
    "3C94" : ["/scratch/gpfs/ed5754/3C94/3C94_TX-20-10-7_Data1_Seq2Scalar_Downsampled_FullFixed.json", 2, 470, 600],
    "3F4" : ["/scratch/gpfs/ed5754/3F4/3F4_E-32-6-20-R_Data1_Seq2Scalar_Downsampled_FullFixed.json", 3, 410, 2000],
    "N30" : ["/scratch/gpfs/ed5754/N30/N30_22.1X13.7X6.35_Data1_Seq2Scalar_Downsampled_FullFixed.json", 4, 380, 200],
    "N49" : ["/scratch/gpfs/ed5754/N49/N49_R16.0X9.6X6.3_Data1_Seq2Scalar_Downsampled_FullFixed.json", 5, 490, 1800],
}
...
class MaterialHead(nn.Module):
    def __init__(self, output_features, trial, task):
        ...
        for i in range(layers):
                out_features = trial.suggest_int("head_units_{}".format(i), 3, 25)
...
def objective(trial):
    ...
    NUM_EPOCH = trial.suggest_int("epoch", 70, 900)
    LR_INI = trial.suggest_float("LR", 0.0001, 0.01)

    LR_SCALEFACTOR = trial.suggest_float("MIN_LR", 1.1, 8.1)
    MIN_LR = LR_INI / LR_SCALEFACTOR
    ...
    net = MagUniformer(
      ...
      dropout_encoder=0.0, 
      dropout_pos_enc=0.0,
      dim_feedforward_encoder=trial.suggest_int("dim_FFL", 16, 48),
      projected_variables=1,
      parameter_variables=2,
      output_features=trial.suggest_int("out_f", 1, 16),
      num_materials=6,
      encoder_l=32,
...
if __name__ == "__main__":
    ...
    study_name = "LongTrials"  # Unique identifier of the study.
