...
TRANSFER_LEARN = True
TRANSFER_LR = 0.0173009986995873
TRANSFER_MINLR = 0.0005054873034822468
TRANSFER_EPOCH = 279
TRANSFER_BATCH = 144
...
# }
transferMaterial = {
    "N27" : ["/scratch/gpfs/ed5754/N27_TL/N27_R20.0X10.0X7.0_Data1_Seq2Scalar_Downsampled_Full.json", 11, 500,700,2000]
}
...
def transferLearn():
    ...
    for DATA_SIZE in range(100,5000,100):
        ...
        # Tstate_dict = torch.load('/scratch/gpfs/ed5754/ExperimentalHead2.sd')
...
def limitedTL(trial):
    ...
    TLRINI = trial.suggest_float("LR", 0.0008, 0.07)
...
#ExperimentalHead6.sd is AVG
    ...
    transferNetwork = loadMaterialNetwork(1, numFeatures)
    Tstate_dict = torch.load('/scratch/gpfs/ed5754/ExperimentalHead' + str(listIndex) + '.sd')
    transferNetwork.load_state_dict(Tstate_dict, strict=False)
...
def optimizeMe():
    study_name = "N27TLLimited"  # Unique identifier of the study.
